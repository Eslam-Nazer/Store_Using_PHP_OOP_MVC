            ...
            <div class="bg-[#feffff] w-full pt-10 pb-3 px-5 border-2 border-gray-400 rounded-md">
                <div class="flex">
                    <div class="relative z-0 w-1/2">
                        <input <?= $this->session->lang == "ar" ? 'dir="rtl"' : 'dir=ltr' ?> name="Name" value="<?= $this->showValue("Name", $supplier)  ?>" type="text" id="floating_standard" class="font-inter w-full block py-2.5 px-2 text-lg text-gray-900 bg-transparent ltr:border-r-2 rtl:border-l-2 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-b-[#0088a9] peer" placeholder=" " maxlength="40" />
                    ...
                    <div class="relative z-0 w-1/2">
                        <input name="Email" value="<?= $this->showValue("Email", $supplier) ?>" type="email" id="floating_standard" class="font-inter w-full block py-2.5 px-2 text-lg text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-b-[#0088a9] peer" placeholder=" " />
                ...
                <div class="flex">
                    <div class="relative z-0 w-1/2">
                        <input <?= $this->session->lang == "ar" ? 'dir="rtl"' : 'dir=ltr' ?> name="NameAr" value="<?= $this->showValue("NameAr", $supplier) ?>" type="text" id="floating_standard" class="font-zain w-full block pt-4 pb-2 px-2 text-lg text-gray-900 bg-transparent ltr:border-r-2 rtl:border-l-2 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-b-[#0088a9] peer" placeholder=" " maxlength="40" />
                    ...
                    <div class="relative z-0 w-1/2">
                        <input <?= $this->session->lang == "ar" ? 'dir="rtl"' : 'dir=ltr' ?> name="PhoneNumber" value="<?= $this->showValue("PhoneNumber", $supplier) ?>" type="text" id="floating_standard" class="font-inter w-full block pt-4 pb-2 px-2 text-lg text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-b-[#0088a9] peer" placeholder=" " maxlength="40" />
                        <label for="floating_standard" class="absolute px-2 pt-2 text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-[#0088a9] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
                ...
                <div class="flex">
                    <div class="relative z-0 w-1/2">
                        <input name="Address" value="<?= $this->showValue("Address", $supplier) ?>" type="text" id="floating_standard" class=" w-full block pt-4 pb-2 px-2 text-lg text-gray-900 bg-transparent ltr:border-r-2 rtl:border-l-2 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-b-[#0088a9] peer" placeholder=" " maxlength="50" />
                        <label for="floating_standard" class="absolute px-2 pt-2 text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-[#0088a9] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
                            <?= $text_label_Address ?>
                        </label>
                    </div>
                    ...
                    <div class="relative z-0 w-1/2">
                        <input name="AddressAr" dir="rtl" value="<?= $this->showValue("AddressAr", $supplier) ?>" type="text" id="floating_standard" class="font-zain w-full block pt-4 pb-2 px-2 text-lg text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-b-[#0088a9] peer" placeholder=" " maxlength="50" />
                        <label for="floating_standard" class="absolute px-2 pt-2 text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-[#0088a9] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
