            ...
            <div class="bg-slate-200 w-full pt-10 pb-3 px-5 border-2 border-gray-400 rounded-xl">
                <div class="flex">
                    <div class="relative z-0">
                        <input name="name" type="text" id="floating_standard" class="block border-r-2 py-2.5 mr-48 px-0 w-full  text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#0088a9] focus:outline-none focus:ring-0 focus:border-[#0088a9] peer" placeholder=" " />
                    ...
                    <div class="relative z-0">
                        <div id="Gender" class="block py-2.5 px-2 pl-6 mr-48 w-full text-lg border-b-2 border-gray-300">
                            <input value="male" class="" type="radio" name="gender" id="male-radio">
                            <label class="hover:text-[#0088a9]" for="male-radio">Male</label>
                            <input value="female" class="pl-3" type="radio" name="gender" id="female-radio">
                ...
                <div class="flex">
                    <div class="relative z-0">
                        <input name="age" min="22" max="60" type="number" id="floating_standard" class="block border-r-2 py-2.5 mr-20 pb-2 pt-[31px] w-full  text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#0088a9] focus:outline-none focus:ring-0 focus:border-[#0088a9] peer" placeholder=" " />
                        <label for="floating_standard" class="absolute text-lg pt-[15px] text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-[#0088a9] peer-focus:dark:text-[#0088a9] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto">
                            Age
                        </label>
                    </div>
                    <div class="relative z-0">
                        <input name="salary" min="1500" max="11000" type="number" id="floating_standard" class="block border-r-2 py-2.5 pb-2 pt-[31px] mr-36 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#0088a9] focus:outline-none focus:ring-0 focus:border-[#0088a9] peer" placeholder=" " />
                ...
                <div class="border-b-2 border-gray-300 p-3">
                    ...
                    <div class="">
                        <input name="windows" id="windows" type="checkbox" value="1" class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 rounded focus:ring-teal-500 dark:focus:ring-teal-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="windows" class="ms-2 text-lg font-medium text-gray-900 dark:text-gray-300">Windows</label>
                    </div>
                    <div class="">
                        <input name="linux" id="linux" type="checkbox" value="1" class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 rounded focus:ring-teal-500 dark:focus:ring-teal-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="linux" class="ms-2 text-lg font-medium text-gray-900 dark:text-gray-300">Linux</label>
                    </div>
                    <div class="">
                        <input name="mac" id="mac" type="checkbox" value="1" class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 rounded focus:ring-teal-500 dark:focus:ring-teal-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
