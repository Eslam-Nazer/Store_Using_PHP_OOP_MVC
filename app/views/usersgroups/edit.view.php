<form action="" method="post" enctype="application/x-www-form-urlencoded">
    <div class="relative mt-8 w-full">
        <div <?= $this->session->lang == 'ar' ? 'dir="rtl"' : 'dir="ltr"' ?> class="py-1 px-3 absolute -top-4 ltr:left-8 rtl:right-4 bg-[#0088a9] text-md font-bold text-[#edf0f1]">
            <?= $text_legend ?>
        </div>
        <div class="overflow-auto mx-2 my-4">
            <div class="bg-[#f2f4f5] w-full pt-10 pb-3 px-5 border-2 border-gray-400 rounded-md">
                <div class="flex">
                    <div <?= $this->session->lang == 'ar' ? 'dir="rtl"' : 'dir="ltr"' ?> class="relative z-0 w-1/2">
                        <input value="<?= $group->GroupName ?>" name="GroupName" type="text" id="floating_standard" class="block font-roboto ltr:border-r-2 rtl:border-l-2 py-2.5 px-2 w-full text-lg text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-b-[#0088a9] peer" placeholder=" " />
                    ...
                    <div <?= $this->session->lang == 'ar' ? 'dir="rtl"' : null ?> class="relative z-0 w-1/2">
                        <input value="<?= $group->GroupNameAr ?>" name="GroupNameAr" dir="rtl" type="text" id="floating_standard" class="block font-zain py-2.5 px-2 w-full text-lg text-gray-900 bg-transparent border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#0088a9] peer" placeholder=" " />
                ...
                <div class="border-b-2 border-gray-300 p-3" <?= $this->session->lang == 'ar' ? 'dir="rtl"' : null ?>>
                    ...
                    ?>
                            <div>
                                <input name="Privileges[]" id="<?= $privilege->PrivilegeTitle ?>" type="checkbox" value="<?= $privilege->PrivilegeId ?>" class="w-4 h-4 text-teal-600 bg-gray-100 border-gray-300 rounded focus:ring-[#0088a9] dark:focus:ring-[#0088a9] focus:ring-2" <?= in_array($privilege->PrivilegeId, $groupPrivileges) ? 'checked' : null ?>>
